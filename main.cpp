...
int main(int argc, const char* argv[])
{
	...
	args::ValueFlag<std::string> annotation_prefix { parser, "annotation prefix", "The prefix for all annotation macros", { 'a', "aprefix" }, "R", args::Options::Single | args::Options::HiddenFromUsage };
	args::ValueFlag<std::string> reflection_prefix{ parser, "reflection prefix", "The prefix for all autogenerated macros this tool will generate", { 'r', "rprefix" }, "REFLECT", args::Options::Single | args::Options::HiddenFromUsage };
