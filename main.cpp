...
int main(int argc, const char* argv[])
{
	...
	args::ValueFlag<std::string> artifact_path{ parser, "artifact path", "Path to the directory where the general artifact files will be created", { "artifacts" }, "", args::Options::Single | args::Options::HiddenFromUsage };
